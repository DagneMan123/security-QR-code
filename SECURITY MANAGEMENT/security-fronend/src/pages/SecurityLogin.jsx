...
const SecurityLogin = ({ setToken }) => {
  const { login, navigate } = useContext(SecurityContext);
  ...
  if (!officerId.trim()) { 
    setLoading(false);
    return setError("Officer ID is required.");
  }

  try {
    const result = await login(email, officerId);
    ...
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-gray-900 via-gray-950 to-gray-900 p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center p-4 bg-linear-to-r from-blue-500 to-indigo-600 rounded-2xl mb-4">
            <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
            </svg>
          </div>
          <h1 className="text-3xl font-bold text-white mb-2">Security Portal</h1>
          <p className="text-gray-400">Security Officer Login</p>
        </div>
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden border border-gray-700/50">
          <div className="p-8">
            ...
            <form onSubmit={onSubmitHandler} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    value={email}
                    className="w-full px-4 py-3 pl-11 bg-gray-900/50 border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors backdrop-blur-sm"
                    type="email"
              ...
              {/* Officer ID */}
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2">Officer ID</label>
                <div className="relative">
                  <input
        ...
        <div className="text-center mt-8">
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} Security Portal. All rights reserved.
          </p>
        </div>
      </div>
    </div>
